...
public class Funcionario implements Serializable {
    ...
    // Anotação serve para falar que a jpa deve ignorar esse metodo, não faz parte do mapeamento
    @Transient
    ...
    // FetchType.EAGER -> sempre que eu carregar o funcionário, já quero ter os dados da empresa
